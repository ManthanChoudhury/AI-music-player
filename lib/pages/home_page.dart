...
import 'package:jarvis/model/radio.dart';
import 'package:jarvis/utils/ai_util.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  setupAlan() {
    AlanVoice.addButton(
        "7dc848aff4de8220fd456113d3e2126a2e956eca572e1d8b807a3e2338fdd0dc/stage",
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          [
            AppBar(
              title: "Jarvis".text.xl4.bold.white.make().shimmer(
